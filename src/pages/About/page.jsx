...
import { aboutbanner, aboutimg, galryimage1, galryimage10, galryimage11, galryimage2, galryimage3, galryimage4, galryimage5, galryimage6, galryimage7, galryimage8, galryimage9, galryimg1, galryimg2, galryimg3, galryimg4, galryimg5, historyimg, innerbanner } from '../../images/images'
      ...
      <section className="welcome-sec">
        <div className="container">
          <div className="welcome-sec-inr">
            <h3 className="fade-in">Welcome To <span>GBCD..</span></h3>
