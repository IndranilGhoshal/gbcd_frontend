...
import { galryimage1, galryimage10, galryimage11, galryimage2, galryimage3, galryimage4, galryimage5, galryimage6, galryimage7, galryimage8, galryimage9, galryimg1, galryimg2, galryimg3, galryimg4, galryimg5, historyimg, innerbanner, ourpresencebanner, ourpresenceimg } from '../../images/images';
      ...
      {/* <section class="banner-sec">
        <div class="container-fluid px-0">
          <OwlCarousel
            ...
            animateOut='fadeOut'
          >
            <div><img src={ourpresencebanner} /></div>
      ...
      <section class="history-sec">
        <div class="container-fluid px-0">
          <div class="history-sec-inner">
            <div class="histry-img"><img src={ourpresenceimg} /></div>
            <div class="histry-cont">
              <h3 class="fade-in"><span>GBCD</span> Presence </h3>
              <p class="fade-in">In Pandua, Polba-Dadpur, Balagarh and Dhaniakhali blocks of Hooghly District.</p>
              <p class="fade-in">In addition to that people from adjacent blocks like Chinsurah-Mogra of Hooghly District and
                Jamalpur, Kalna & Memari blocks of East Burdwan District are also receiving support from
                our organization.</p>
            </div></div>
        </div>
      </section>
